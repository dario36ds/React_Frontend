...
function AlbumDetailsDialog({ album, rank, open, onClose }) {
  return (
    <Dialog
      open={open}
      onClose={onClose}
    ...
    >
      <Box
        sx={{
          ...
          alignItems: "center",
          background: (theme) =>
            `linear-gradient(135deg, ${theme.palette.secondary.main}22, ${theme.palette.background.paper} 65%)`,
        }}
      >
        <Box
          component="img"
        ...
        <Box sx={{ minWidth: 0, textAlign: "left" }}>
          ...
          <Typography color="text.secondary">{album.artistName}</Typography>
        </Box>
